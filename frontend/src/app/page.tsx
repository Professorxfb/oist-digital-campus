...
function ProfessorCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-[10px] border border-white bg-white shadow-[0_18px_44px_rgba(2,6,23,0.06)] transition duration-300 hover:-translate-y-1 hover:border-[#064c78] hover:shadow-[0_24px_60px_rgba(2,6,23,0.12)]">
      <Link
