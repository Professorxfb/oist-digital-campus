...
export function generateMetadata() {
  return createCmsMetadata({
    ...
    description: "Student portal access will be available when portal authentication is launched.",
  });
}

export default function StudentPortalPlaceholderPage() {
  return (
    <PublicSiteShell>
      <PageIntro
        eyebrow="Portal"
      ...
      <Container className="py-12 sm:py-16">
        <section className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
          ...
          <p className="mt-4 max-w-2xl text-base leading-8 text-slate-600">
            This public placeholder does not include login or protected student features yet.
          </p>
          <div className="mt-7">
